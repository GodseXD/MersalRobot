...
import MersalRobot.modules.sql.connection_sql as sql
from MersalRobot import dispatcher, DRAGONS, DEV_USERS
from MersalRobot.modules.helper_funcs import chat_status
