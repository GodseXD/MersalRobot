from MersalRobot.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
from telegram.ext import CommandHandler, MessageHandler, CallbackQueryHandler, InlineQueryHandler
from telegram.ext.filters import BaseFilter
from MersalRobot import dispatcher as d, LOGGER
...
mersalcmd = MersalTelegramHandler(d).command
mersalmsg = MersalTelegramHandler(d).message
mersalcallback = MersalTelegramHandler(d).callbackquery
mersalinline = MersalTelegramHandler(d).inlinequery
