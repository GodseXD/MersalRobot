...
from MersalRobot import OWNER_ID, SUPPORT_CHAT, UPDATES_CHANNEL
...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./MersalRobot/resources/LOGOS/*")
    ...
    fname = "logo.png"
    img.save(fname, "png")
    vegeta = [[Button.url("MADE BY MERSAL", "t.me/MersalRobot")]]
    await tbot.send_file(event.chat_id, file=fname,buttons=mersal)
