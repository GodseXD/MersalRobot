...
from MersalRobot import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher,StartTime,SUPPORT_CHAT,sw,UPDATES_CHANNEL)
from MersalRobot.__main__ import STATS, TOKEN, USER_INFO
import MersalRobot.modules.sql.userinfo_sql as sql
...
from MersalRobot.modules.sql.afk_sql import is_afk, check_afk_status
from MersalRobot.modules.sql.users_sql import get_user_num_chats
from MersalRobot.modules.helper_funcs.chat_status import sudo_plus
from MersalRobot.modules.helper_funcs.extraction import extract_user
from MersalRobot import telethn as tbot , TIGERS, DRAGONS, DEMONS
