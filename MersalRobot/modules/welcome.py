...
import MersalRobot.modules.sql.welcome_sql as sql
from MersalRobot import (SUPPORT_CHAT, UPDATES_CHANNEL, DEV_USERS, LOGGER, OWNER_ID, DRAGONS, DEMONS, TIGERS,
                          WOLVES, sw, dispatcher, JOIN_LOGGER)
from MersalRobot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from MersalRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from MersalRobot.modules.helper_funcs.msg_types import get_welcome_type
from MersalRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from MersalRobot.modules.log_channel import loggable
from MersalRobot.modules.sql.global_bans_sql import is_user_gbanned
...
OWNER_IMG= "http://telegra.ph/file/dad52dfba82ba6ac43785.jpg"
